...
"<textarea id='device_location' name='device_location' maxlength='150' rows='3' placeholder='Describe the location where this device is installed...' required></textarea>"
"</div>"
"<div class='form-group'>"
...
"if(data.success){"
"document.getElementById('status').innerHTML='<div class=\"success\">✅ Configuration saved successfully!<br>Device will restart and connect to your WiFi.</div>';"
"setTimeout(()=>{window.location.href='/';},3000);"
"}else{"
"document.getElementById('status').innerHTML='<div class=\"error\">❌ Configuration failed: '+data.message+'</div>';"
"}"
"}).catch(e=>{"
"document.getElementById('status').innerHTML='<div class=\"error\">❌ Configuration failed</div>';"
"});}"
"</script></body></html>";
